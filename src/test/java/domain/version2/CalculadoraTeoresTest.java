...
import static domain.version2.CalculadoraTeores.Textura.TEXTURA_MEDIA;
...
class CalculadoraTeoresTest {
    ...
    private CalculadoraTeores getCalculadoraTeores() {
        var amostra = new CalculadoraTeores.ParametrizacaoSolo(8.59, 0.15, 5.76, 1.63, 3.76, 0, 5.35);
        return new CalculadoraTeores(TEXTURA_MEDIA, "Plantio Direto", amostra, 30.69, 0, "", 20, 761);
    }
}